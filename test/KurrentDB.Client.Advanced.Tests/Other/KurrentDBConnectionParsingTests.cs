...
// using System.Net;
// using KurrentDB.Client.Configuration;
//
// namespace KurrentDB.Client.Advanced.Tests;
//
...
//
// 		// Act
// 		var settings = KurrentDBConnectionSettings.Parse(connectionString);
//
// 		// Assert
...
//
// 		// Act
// 		var result = KurrentDBConnectionSettings.TryParse(connectionString, out var settings);
//
// 		// Assert
// 		result.ShouldBeTrue();
// 		settings.Scheme.ShouldBe(ConnectionScheme.Direct);
...
// 		settings.ShouldBe(default(KurrentDBConnectionSettings));
// 	}
// }
//
...
// 		// Arrange
// 		var settings = new KurrentDBConnectionSettings(
...
//
// 		// Act & Assert
// 		settings.EffectiveKeepAliveInterval.ShouldBe(KurrentDBConnectionSettings.DefaultKeepAliveInterval);
// 		settings.EffectiveKeepAliveTimeout.ShouldBe(KurrentDBConnectionSettings.DefaultKeepAliveTimeout);
// 	}
//
// 	[Test]
...
// 			UserCredentials: new KurrentDB.Client.Configuration.UserCredentials("admin", "password")
// 		);
//
// 		// Act & Assert
...
// 		// Arrange & Act
// 		var emptyCredentials         = new KurrentDB.Client.Configuration.UserCredentials();
// 		var nullCredentials          = new KurrentDB.Client.Configuration.UserCredentials(null, null);
// 		var emptyUsernameCredentials = new KurrentDB.Client.Configuration.UserCredentials("", "password");
// 		var validCredentials         = new KurrentDB.Client.Configuration.UserCredentials("admin", "password");
//
// 		// Assert
...
// 			UserCredentials: new KurrentDB.Client.Configuration.UserCredentials("admin", "changeit")
// 		);
//
// 		// Act
// 		var connectionString = settings.ToString();
...
// 			Scheme: ConnectionScheme.Direct,
// 			Endpoints: ImmutableArray.Create<EndPoint>(new DnsEndPoint("localhost", 2113)),
// 			UserCredentials: new KurrentDB.Client.Configuration.UserCredentials("user@domain.com", "p@ssw$rd"),
...
// 		// Arrange
// 		var originalSettings = new KurrentDBConnectionSettings(
// 			Scheme: ConnectionScheme.Discover,
// 			Endpoints: ImmutableArray.Create<EndPoint>(new DnsEndPoint("cluster.local", 2113)),
// 			UserCredentials: new KurrentDB.Client.Configuration.UserCredentials("admin", "changeit"),
...
// 		var parsedSettings   = KurrentDBConnectionSettings.Parse(connectionString);
//
// 		// Assert
...
// 		// Act & Assert
// 		Should.Throw<ArgumentException>(() => KurrentDBConnectionSettings.Parse(null!));
// 	}
//
// 	[Test]
// 	public void Parse_EmptyConnectionString_ShouldThrowArgumentException() {
// 		// Act & Assert
// 		Should.Throw<ArgumentException>(() => KurrentDBConnectionSettings.Parse(""));
// 	}
//
// 	[Test]
...
// 			KurrentDBConnectionSettings.Parse(connectionString)
// 		);
//
...
//
// 		// Act & Assert
// 		Should.Throw<KurrentDBConnectionStringException>(() => KurrentDBConnectionSettings.Parse(connectionString));
// 	}
//
// 	[Test]
