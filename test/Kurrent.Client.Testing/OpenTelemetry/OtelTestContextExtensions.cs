namespace Kurrent.Client.Testing.OpenTelemetry;
...
public static class OtelTestContextExtensions {
    ...
    public static void SetOtelServiceName(this TestContext context, string serviceName) => SetOtelServiceMetadata(context, new(serviceName));
}
