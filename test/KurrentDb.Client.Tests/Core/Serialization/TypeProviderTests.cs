...
namespace KurrentDb.Client.Tests.Core.Serialization {
	...
	public class TypeProviderTests {
		...
		public void GetTypeByFullName_ForNestedNamespacesSortsAssembliesByNamespace_AndReturnsFirstMatch() {
			...
			string nestedType   = typeof(KurrentDb.Client.Tests.Core.Serialization.Nested.TestNestedNamespaceEvent).FullName!;
	...
	/// Uses KurrentDb.Client.Tests.NeverLoadedAssembly project which should never be loaded before this test runs
	/// </summary>
	public class UnloadedAssemblyTests {
		const string NotLoadedTypeFullName = "KurrentDb.Client.Tests.NeverLoadedAssembly.NotLoadedExternalEvent";
	...
	/// Uses KurrentDb.Client.Tests.ExternalAssembly.dll which will be explicitly loaded during the tests
	/// </summary>
	public class LoadedAssemblyTests {
		const    string   ExternalAssemblyName = "KurrentDb.Client.Tests.ExternalAssembly";
		const    string   ExternalTypeFullName = "KurrentDb.Client.Tests.ExternalAssembly.ExternalEvent";
