...
public class SubscribeToStreamObsoleteTests(ITestOutputHelper output, SubscribeToStreamObsoleteTests.CustomFixture fixture)
	: KurrentTemporaryTests<SubscribeToStreamObsoleteTests.CustomFixture>(output, fixture) {
	[Fact]
