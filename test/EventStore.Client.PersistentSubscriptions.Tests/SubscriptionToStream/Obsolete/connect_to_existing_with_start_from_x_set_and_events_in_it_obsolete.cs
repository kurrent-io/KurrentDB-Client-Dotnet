...
public class connect_to_existing_with_start_from_x_set_and_events_in_it_obsolete
	...
	const string Stream =
		nameof(connect_to_existing_with_start_from_x_set_and_events_in_it_obsolete);

	readonly Fixture _fixture;

	public connect_to_existing_with_start_from_x_set_and_events_in_it_obsolete(Fixture fixture) => _fixture = fixture;
