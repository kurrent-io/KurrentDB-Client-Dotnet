...
public class SubscribeToStreamGetInfoTests(SubscribeToStreamGetInfoTests.CustomFixture fixture)
	: IClassFixture<SubscribeToStreamGetInfoTests.CustomFixture> {
	...
	public class CustomFixture : KurrentTemporaryFixture {
		...
		KurrentPersistentSubscriptionsClient.PersistentSubscriptionResult? Subscription;
