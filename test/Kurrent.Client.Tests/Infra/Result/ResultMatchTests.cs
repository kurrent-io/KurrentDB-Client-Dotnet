...
public class ResultMatchTests {
    ...
    public void match_executes_success_function_when_matching_success_result() {
        ...
        Kurrent.Client.Result<GameStarted, InvalidMoveError> result = Kurrent.Client.Result<GameStarted, InvalidMoveError>.Success(successValue);
    ...
    public void match_executes_error_function_when_matching_error_result() {
        ...
        Kurrent.Client.Result<GameStarted, InvalidMoveError> result = Kurrent.Client.Result<GameStarted, InvalidMoveError>.Error(errorValue);
    ...
    public async Task match_async_handles_mixed_sync_async_scenarios() {
        // Arrange
        GameStarted successValue = new GameStarted(Faker.Random.Guid(), Faker.PickRandom<Player>());
        Kurrent.Client.Result<GameStarted, InvalidMoveError> successResult = Kurrent.Client.Result<GameStarted, InvalidMoveError>.Success(successValue);
        InvalidMoveError errorValue = new InvalidMoveError(Faker.Random.Guid(), Faker.Lorem.Sentence());
        Kurrent.Client.Result<GameStarted, InvalidMoveError> errorResult = Kurrent.Client.Result<GameStarted, InvalidMoveError>.Error(errorValue);
