...
// 			ConnectionScheme.Direct,
// 			[new DnsEndPoint("localhost", 2113)],
// 			Tls: new KurrentClientTlsOptions(false, false, "/path/to/ca.crt")
// 		);
//
// 		// Act
// 		var result = settings.Validate();
...
//
// 		// Act & Assert
// 		settings.EffectiveTls.ShouldBe(KurrentClientTlsOptions.Default);
// 		settings.EffectiveTls.Enabled.ShouldBeTrue();
...
// 			ConnectionScheme.Direct,
// 			[new DnsEndPoint("localhost", 2113)],
// 			Tls: KurrentClientTlsOptions.Insecure
// 		);
//
// 		// Act
// 		var connectionString = settings.ToString();
...
// 			UserCredentials: new UserCredentials("admin", "password"),
// 			Tls: new KurrentClientTlsOptions(true, false, "/ca.crt"),
// 			Gossip: new GossipSettings(
// 				5,
...
// 			Endpoints: ImmutableArray.Create<EndPoint>(new DnsEndPoint("cluster.local", 2113)),
// 			UserCredentials: new UserCredentials("admin", "changeit"),
// 			Tls: new KurrentClientTlsOptions(false),
// 			ConnectionName: "TestConnection",
...
// 		// Act & Assert
// 		KurrentClientTlsOptions.Default.Enabled.ShouldBeTrue();
// 		KurrentClientTlsOptions.Default.VerifyCertificate.ShouldBeTrue();
// 		KurrentClientTlsOptions.Default.CaFile.ShouldBeNull();
//
// 		KurrentClientTlsOptions.Insecure.Enabled.ShouldBeFalse();
// 		KurrentClientTlsOptions.Insecure.VerifyCertificate.ShouldBeFalse();
// 		KurrentClientTlsOptions.Insecure.CaFile.ShouldBeNull();
// 	}
//
// 	// [Test]
...
// 			ConnectionName: null,
// 			Tls: KurrentClientTlsOptions.Default
// 		);
//
// 		// Act
// 		var connectionString = settings.ToString();
...
// 			NodePreference: NodePreference.Leader,
// 			ConnectionName: null,
// 			Tls: new KurrentClientTlsOptions(true, true)
// 		);
//
// 		// Act
// 		var connectionString = settings.ToString();
