...
<p>Currently, OpenTelemetry observability support is not available for all
clients. Moreover, instrumentation is only provided for append and
subscribe operations, which includes both 'Catchup' and 'Persistent' modes.</p>
</div>
<p>Click <a href="https://github.com/kurrent-io/KurrentDB-Client-Dotnet/blob/master/samples/diagnostics/Program.cs" target="_blank" rel="noopener noreferrer">here</a> to view the full sample code for observability.</p>
...
<p>@<a href="@grpc:diagnostics/Program.cs">code{register-instrumentation}</a></p>
<h2 id="traces" tabindex="-1"><a class="header-anchor" href="#traces"><span>Traces</span></a></h2>
...
client:</p>
<p>@<a href="@grpc:diagnostics/Program.cs">code{setup-exporter}</a></p>
<p>For more details on configuring exporters for specific programming languages,
