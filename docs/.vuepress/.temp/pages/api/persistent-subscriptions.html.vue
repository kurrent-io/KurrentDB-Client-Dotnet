...
<h2 id="creating-a-subscription-group" tabindex="-1"><a class="header-anchor" href="#creating-a-subscription-group"><span>Creating a subscription group</span></a></h2>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{create-persistent-subscription-to-stream}</a></p>
<table>
<thead>
<tr>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{create-persistent-subscription-to-all}</a></p>
<h2 id="connecting-a-consumer" tabindex="-1"><a class="header-anchor" href="#connecting-a-consumer"><span>Connecting a consumer</span></a></h2>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{subscribe-to-persistent-subscription-to-stream}</a></p>
<table>
<thead>
<tr>
<th style="text-align:left">Parameter</th>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{subscribe-to-persistent-subscription-to-all}</a></p>
<p>The <code v-pre>SubscribeToAllAsync</code> method is identical to the <code v-pre>SubscribeToStreamAsync</code> method, except that you don't need to specify a stream name.</p>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{subscribe-to-persistent-subscription-with-manual-acks}</a></p>
<p>The <em>Nack event action</em> describes what the server should do with the message:</p>
<table>
<thead>
<tr>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{update-persistent-subscription}</a></p>
<table>
<thead>
<tr>
<th style="text-align:left">Parameter</th>
...
<p>@<a href="@grpc:persistent-subscriptions/Program.cs">code{delete-persistent-subscription}</a></p>
<table>
<thead>
<tr>
<th style="text-align:left">Parameter</th>
