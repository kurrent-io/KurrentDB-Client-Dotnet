...
namespace KurrentDb.Client {
	...
	public sealed class KurrentUserManagementClient : KurrentClientBase {
		...
		/// <summary>
		/// Constructs a new <see cref="KurrentUserManagementClient"/>.
		/// </summary>
		/// <param name="settings"></param>
		public KurrentUserManagementClient(KurrentClientSettings? settings = null) :
			base(settings, ExceptionMap) {
			_log = Settings.LoggerFactory?.CreateLogger<KurrentUserManagementClient>() ??
			       new NullLogger<KurrentUserManagementClient>();
		}
