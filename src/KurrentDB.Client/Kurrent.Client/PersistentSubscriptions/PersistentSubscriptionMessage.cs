...
public abstract record PersistentSubscriptionMessage {
	...
	/// <param name="RetryCount">The number of times the <see cref="KurrentDB.Client.ResolvedEvent"/> has been retried.</param>
	public record Event(Record ResolvedEvent, int? RetryCount) : PersistentSubscriptionMessage;
