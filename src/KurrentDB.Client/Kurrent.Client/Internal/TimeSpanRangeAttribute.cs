...
public sealed class TimeSpanRangeAttribute : ValidationAttribute
{
	...
	{
		return $"{name} must be greater than or equal to {TimeSpan.FromMilliseconds(MinMilliseconds)} and less than or equal to {TimeSpan.FromMilliseconds(MaxMilliseconds)}.";
	}
}
