...
using static KurrentDB.Protocol.Registry.V2.RegistryErrorDetails;
...
public static partial class ErrorDetails {
    ...
    /// <summary>
    /// Represents an error indicating that the specified schema has already been created and cannot be created again.
    /// </summary>
