...
public static partial class StreamsClientExtensions {
    ...
    public static ValueTask<Result<AppendStreamSuccesses, AppendStreamFailures>> Append(this Streams.StreamsClient client, IEnumerable<AppendStreamRequest> requests, CancellationToken cancellationToken = default) =>
        client.Append(requests.ToAsyncEnumerable(), cancellationToken);

    public static ValueTask<Result<AppendStreamSuccesses, AppendStreamFailures>> Append(this Streams.StreamsClient client, MultiStreamAppendRequest request, CancellationToken cancellationToken = default) =>
    ...
    public static async ValueTask<Result<AppendStreamSuccess, AppendStreamFailure>> Append(this Streams.StreamsClient client, AppendStreamRequest request, CancellationToken cancellationToken) {
    ...
    public static ValueTask<Result<AppendStreamSuccess, AppendStreamFailure>> Append(this Streams.StreamsClient client, StreamName stream, ExpectedStreamState expectedState, IEnumerable<Message> messages, CancellationToken cancellationToken) =>
        client.Append(new AppendStreamRequest(stream, expectedState, messages), cancellationToken);

    public static ValueTask<Result<AppendStreamSuccess, AppendStreamFailure>> Append(this Streams.StreamsClient client, StreamName stream, ExpectedStreamState expectedState, Message message, CancellationToken cancellationToken) =>
        client.Append(new AppendStreamRequest(stream, expectedState, [message]), cancellationToken);

    public static ValueTask<Result<AppendStreamSuccess, AppendStreamFailure>> Append(this Streams.StreamsClient client, StreamName stream, IEnumerable<Message> messages, CancellationToken cancellationToken) =>
