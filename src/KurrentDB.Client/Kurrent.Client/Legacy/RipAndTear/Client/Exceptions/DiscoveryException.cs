...
public class DiscoveryException : KurrentException {
	...
	[Obsolete]
	public DiscoveryException(string message, Exception? innerException = null) : base(message, innerException) =>
	...
	public DiscoveryException(int maxDiscoverAttempts) : base($"Failed to discover candidate in {maxDiscoverAttempts} attempts.") =>
