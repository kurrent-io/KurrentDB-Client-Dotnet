...
partial class KurrentDBPersistentSubscriptionsClient {
    ...
    /// </summary>
    internal async Task<PersistentSubscriptionInfo> GetInfoToAllAsync(
    ...
    /// </summary>
    internal async Task<PersistentSubscriptionInfo> GetInfoToStreamAsync(
        ...
        return await GetInfoHttpAsync(
                streamName, groupName, channelInfo,
    ...
    async Task<PersistentSubscriptionInfo> GetInfoGrpcAsync(
        ...
        var result = await new PersistentSubscriptionsServiceClient(callInvoker)
            .GetInfoAsync(
