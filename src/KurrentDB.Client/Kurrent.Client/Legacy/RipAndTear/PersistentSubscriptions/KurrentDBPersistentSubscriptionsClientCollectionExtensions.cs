...
/// </summary>
static class KurrentDBPersistentSubscriptionsClientCollectionExtensions {
    /// <summary>
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static IServiceCollection AddKurrentDBPersistentSubscriptionsClient(
        this IServiceCollection services, Action<KurrentDBClientSettings>? configureSettings = null
    ) =>
