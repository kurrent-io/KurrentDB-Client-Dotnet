...
partial class KurrentDBPersistentSubscriptionsClient {
    ...
    internal async Task CreateToStreamAsync(
    ...
    /// </summary>
    internal async Task CreateToAllAsync(
    ...
    async Task CreateInternalAsync(
        ...
        using var call = new PersistentSubscriptionsService.PersistentSubscriptionsServiceClient(channelInfo.CallInvoker).CreateAsync(
            new CreateReq {
                Options = new CreateReq.Types.Options {
                    Stream = streamName != SystemStreams.AllStream
                        ? StreamOptionsForCreateProto(
                            streamName,
