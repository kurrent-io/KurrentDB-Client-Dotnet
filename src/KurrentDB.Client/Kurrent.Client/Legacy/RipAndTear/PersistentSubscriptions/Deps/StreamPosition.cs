...
/// </summary>
readonly struct StreamPosition : IEquatable<StreamPosition>, IComparable<StreamPosition>, IComparable, IPosition {
	...
	/// </summary>
	public static readonly StreamPosition End = new(ulong.MaxValue);
	...
	/// <param name="value"></param>
	/// <returns></returns>
	public static implicit operator StreamPosition(ulong value) => new(value);
