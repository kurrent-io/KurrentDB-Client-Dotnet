...
/// </summary>
readonly struct RegularFilterExpression : IEquatable<RegularFilterExpression> {
	/// <summary>
	...
	/// </summary>
	/// <returns></returns>
	public static readonly RegularFilterExpression ExcludeSystemEvents = new(new Regex(@"^[^\$].*"));
