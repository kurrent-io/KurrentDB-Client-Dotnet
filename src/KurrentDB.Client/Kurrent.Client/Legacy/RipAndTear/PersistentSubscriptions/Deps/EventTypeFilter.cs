...
/// </summary>
readonly struct EventTypeFilter : IEquatable<EventTypeFilter>, IEventFilter {
    /// <summary>
    ...
    /// <returns></returns>
    public static EventTypeFilter ExcludeSystemEvents(uint maxSearchWindow = 32) => new(maxSearchWindow, RegularFilterExpression.ExcludeSystemEvents);
    ...
    /// <returns></returns>
    public static IEventFilter Prefix(string prefix) => new EventTypeFilter(new PrefixFilterExpression(prefix));
    ...
    EventTypeFilter(uint maxSearchWindow, RegularFilterExpression regex) {
        if (maxSearchWindow == 0)
            throw new ArgumentOutOfRangeException(
                ...
                maxSearchWindow,
                $"{nameof(maxSearchWindow)} must be greater than 0."
            );
