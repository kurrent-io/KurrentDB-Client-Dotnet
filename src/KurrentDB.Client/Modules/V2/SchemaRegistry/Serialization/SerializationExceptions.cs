...
/// </summary>
public abstract class SchemaSerializationException(string message, SchemaDataFormat dataFormat, Exception? innerException = null) : Exception(message, innerException) {
...
public class SerializationFailedException(SchemaDataFormat dataFormat, Type messageType, Exception? innerException = null)
	: SchemaSerializationException($"Failed to serialize value'{messageType}' using {dataFormat} format.", dataFormat, innerException) {
