...
public class SchemaRegistrationOptions {
	...
	/// </summary>
	public SchemaRegistrationMode RegistrationMode { get; set; } = SchemaRegistrationMode.Auto;

	/// <summary>
	/// Controls schema validation behavior.
	/// </summary>
	public SchemaValidationMode ValidationMode { get; set; } = SchemaValidationMode.Enabled;
	...
	/// </summary>
	public bool AutoMapMessages { get; set; } = true;
