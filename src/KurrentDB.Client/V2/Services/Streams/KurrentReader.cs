...
//
// public class KurrentReader {
// 	public KurrentReader(Func<CancellationToken, ValueTask<CallInvoker>> connect, ISchemaSerializerProvider serializerProvider) {
// 		Proxy              = ThinClientProxy<StreamsServiceClient>.Create(connect);
// 		SerializerProvider = serializerProvider;
// 	}
//
// 	IThinClientProxy<StreamsServiceClient> Proxy              { get; }
...
// 		var session = client.LegacyProxy.ReadStreamAsync(
// 			direction, stream,
...
// 	}
//
// 	public static async ValueTask<Record> ReadFirstStreamRecord(this KurrentClient client, string stream, CancellationToken cancellationToken = default) {
// 		try {
// 			var result = client.LegacyProxy.ReadStreamAsync(
...
// 	}
//
// 	public static async ValueTask<Record> ReadLastStreamRecord(this KurrentClient client, string stream, CancellationToken cancellationToken = default) {
// 		try {
// 			var result = client.LegacyProxy.ReadStreamAsync(
