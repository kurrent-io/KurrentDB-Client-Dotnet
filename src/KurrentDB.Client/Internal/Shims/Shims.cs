...
// 	//
// 	// 	if (!source.IsEmpty) {
// 	// 		if (list._items.Length - list._size < source.Length) list.Grow(checked(list._size + source.Length));
// 	//
...
// 	// 	if (list is null) ThrowHelper.ThrowArgumentNullException(ExceptionArgument.list);
// 	//
// 	// 	if ((uint)index > (uint)list._size) ThrowHelper.ThrowArgumentOutOfRange_IndexMustBeLessOrEqualException();
// 	//
// 	// 	if (!source.IsEmpty) {
// 	// 		if (list._items.Length - list._size < source.Length) list.Grow(checked(list._size + source.Length));
// 	//
...
// 	// 		if (index < list._size) Array.Copy(list._items, index, list._items, index + source.Length, list._size - index);
// 	//
