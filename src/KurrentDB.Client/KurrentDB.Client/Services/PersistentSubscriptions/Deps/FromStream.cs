...
// /// </summary>
// readonly struct FromStream : IEquatable<FromStream>, IComparable<FromStream>, IComparable {
// 	/// <summary>
...
//
// 	readonly StreamPosition? _value;
//
// 	/// <summary>
...
// 			: new(streamPosition);
//
// 	FromStream(StreamPosition? value) => _value = value;
//
// 	/// <summary>
...
// 		? throw new InvalidOperationException($"{nameof(FromStream)}.{nameof(Start)} may not be converted.")
...
// 		if (_value is null) return "Start";
//
// 		if (_value == StreamPosition.End) return "Live";
//
