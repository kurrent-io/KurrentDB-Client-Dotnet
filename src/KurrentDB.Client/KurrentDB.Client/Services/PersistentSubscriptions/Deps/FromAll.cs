...
// 		: new(position);
//
// 	readonly Position? _value;
//
// 	FromAll(Position? value) => _value = value;
//
// 	/// <summary>
...
// 		? throw new InvalidOperationException($"{nameof(FromAll)}.{nameof(Start)} may not be converted.")
...
//
// 		if (_value == Position.End) return "Live";
//
