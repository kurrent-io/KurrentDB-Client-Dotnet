...
public readonly record struct KurrentDBConnectionSettings(
	...
	public static KurrentDBConnectionSettings Parse(string connectionString) =>
		KurrentDBConnectionString.Parse(connectionString);

	public static bool TryParse(string connectionString, out KurrentDBConnectionSettings settings) =>
		KurrentDBConnectionString.TryParse(connectionString, out settings);

	static string ToConnectionString(KurrentDBConnectionSettings settings) {
...
static partial class KurrentDBConnectionString {
	...
	internal static ValidationResult Validate(KurrentDBConnectionSettings settings) {
