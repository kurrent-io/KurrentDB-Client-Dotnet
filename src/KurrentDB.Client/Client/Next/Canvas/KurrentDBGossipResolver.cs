...
/// <summary>
/// Settings specific to the KurrentDBGossipResolver for configuring service discovery behavior.
/// </summary>
public record GossipResolverSettings {
	/// <summary>
	/// Gets the list of gossip seed endpoints used for initial discovery.
	/// These can be either DnsEndPoint or IPEndPoint instances.
	/// </summary>
	public IReadOnlyList<EndPoint> GossipSeeds { get; init; } = new List<EndPoint>();
...
public sealed partial class GossipResolver : PollingResolver {
	...
	public GossipResolver(KurrentDBClientSettings settings, ResolverOptions resolverOptions, IBackoffPolicyFactory backoffPolicyFactory, IGossipClient gossipClient)
