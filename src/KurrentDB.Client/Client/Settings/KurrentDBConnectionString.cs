...
public record KurrentDBConnectionString
{
    ...
    private KurrentDBConnectionString(
        string scheme,
    ...
    private static void ConfigureClientCertificate(KurrentDBClientSettings settings, IReadOnlyDictionary<string, object> options)
    {
